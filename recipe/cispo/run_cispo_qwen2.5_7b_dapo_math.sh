...
project_name='CISPO'
exp_name='CISPO-Early-Qwen2.5-7B-DAPO-Math'
...
# Paths
MODEL_PATH="/mnt/shared-storage-user/llmit/user/lvchengqi/ckpt/xpuyu/qwen2d5-7b_cold-start/20251028062856/hf-170"
...
max_response_length=$((1024 * 20)) # $((1024 * 2)) 

##### DAPO trick: clip-higher
clip_ratio_low=0.2
...
ray job submit --address="http://127.0.0.1:$RAY_DASHBOARD_PORT" \
    ...
    -- python3 -m recipe.cispo.main_dapo \
